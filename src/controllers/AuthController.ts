...
export class AuthController {
    static createAccount = async (req: Request, res: Response) => {
        try {
            ...
            const token = new Token(); // Create new token instance from Token model 
            ...
            res.status(500).json("Internal server error create account");
        }
    };
    ...
    static forgotPassword = async (req: Request, res: Response) => {
        try {
            ...
            // enviar correo con token por ahora esta comentado email
